...
description: "[WORKFLOW] Execute implementation plan by dispatching fresh subagent for each task, with code review between tasks"
...
```
Task tool (subagent-type:code-reviewer):
