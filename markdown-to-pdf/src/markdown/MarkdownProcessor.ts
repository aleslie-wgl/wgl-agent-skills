...
export class MarkdownProcessor {
    ...
    private readonly headingTransform: HeadingTransform;
    private readonly parser: ReturnType<typeof createMarkdownParser>;
     ...
     */
    async process(config: ResolvedPDFConfig): Promise<MarkdownParseResult> {
        // Read markdown file
